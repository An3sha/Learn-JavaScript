...
// console.log(itemList.children[1]);        //use children more instead of child
...
//   console.log(e);
//   console.log(e.target); //<button class="btn btn-dark btn-block" id="button">Click Here</button>
//   console.log(e.target.id); //button
//   console.log(e.target.className); //btn btn-dark btn-block
...
// box.addEventListener("mouseover", runEvent);        // only for inner element like h3
...
function runEvent(e) {
  ...
  // box.style.backgroundColor = "rgb(" + e.offsetX + "," + e.offsetY + ",40)";              //WOWWWWWWWWWwwwwowwww
